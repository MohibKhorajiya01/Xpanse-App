...
class _LoginScreenState extends ConsumerState<LoginScreen> {
  ...
  Future<void> _handleLogin() async {
    ...
    try {
      final cred = await ref.read(authServiceProvider).login(email, password);
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Stack(
        children: [
          Positioned(bottom: -50, left: -50, child: _buildOrb(300, AppColors.primary.withValues(alpha: 0.05))),
          Positioned(top: -100, right: -100, child: _buildOrb(400, AppColors.primary.withValues(alpha: 0.03))),
            ...
            child: SingleChildScrollView(
              ...
              child: Column(
                ...
                children: [
                  ...
                  const SizedBox(height: 24),
                  AppButton(label: 'Login', isLoading: _isLoading, onPressed: _handleLogin),
                    ...
                    child: Row(
                      ...
                      children: [
                        ...
                        GestureDetector(
                          ...
                          child: Text('Sign Up', style: AppTypography.bodySmall.copyWith(color: AppColors.primary, fontWeight: FontWeight.bold)),
                        ),
                      ],
                    ),
                  ),
